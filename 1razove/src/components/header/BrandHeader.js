      ...
      <div className="container">
        <div className="header__wrapper header__wrapper--main">
          <a className="header__logo" href="/">
            <picture>
              <img className="header__img header__img--small" src='/images/logo-small-white.svg' alt="1razovoe logotype" width="247" height="68" />
            </picture>
          </a>
            ...
            <div className={`header__wrapper header__wrapper--menu ${showMenu ? 'header__wrapper--opened' : ''}`}>
              ...
              <div className="header__wrapper header__wrapper--row">
                <a className="header__logo header__logo--mobile" href="/">
                  <picture>
                    <img className="header__img header__img--menu" src="/images/logo-small-blue.svg" alt="1razovoe logotype" width="247" height="56" />
                  </picture>
                </a>
