          ...
          <div className="contacts__card">
            ...
            <li className="contacts__item contacts__item--adress">
              <h2 className="contacts__heading">{data.addressTitle}:</h2>
                <a className="contacts__link" href={data.addressLink} target="_blank">
            ...
            <li className="contacts__item contacts__item--social">
              ...
              <section className="social">
                <ul className="social__list">
                  { data.fbLink && <li className="social__item">
                  ...
                  { data.instaLink && <li className="social__item">
                  ...
                  { data.telegramLink && <li className="social__item">
                  ...
                  { data.ytLink && <li className="social__item">
